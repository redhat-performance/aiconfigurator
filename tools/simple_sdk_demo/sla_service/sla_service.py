...
def post_kv_cache_calc(
    ...
    backend: str = Body("vllm", description="backend name, vllm, sglang, vllm"),
    ...
    *,
    ...
    memory_fraction_kind: str = Body("of_total", description="memory fraction kind, of_total for vllm/sglang, of_free for vllm"),
...
def post_sla(
    ...
    backend: str = Body("vllm", description="backend name, vllm, sglang, vllm"),
    version: str = Body("0.22.0", description="vllm version, 0.22.0"),
    model_path: str = Body("QWEN3_32B", description="model name"),
    isl: int = Body(4000, description="input sequence length"),
    osl: int = Body(500, description="output sequence length"),
